    ...
    <div class="container">
        ...
        <div class="right-column">
            <div class="right-header" id="right-header">
                ...
                <p>The memecoin journey began in December 2013 with <strong>Dogecoin</strong>, created by Billy Markus
                    and Jackson Palmer. Based on the "Doge" meme featuring a Shiba Inu, Dogecoin gained attention for
                    its lighthearted branding and charitable causes.</p>

                <p>Building on Dogecoin's success, <strong>Shiba Inu (SHIB)</strong> launched in 2020, branding itself
                    as the "Dogecoin killer." It quickly gained popularity, forming an ecosystem of tokens and riding
                    the 2021 crypto boom. Other memecoins, like <strong>PepeCoin</strong> and <strong>Floki
                        Inu</strong>, followed suit.</p>
